# Catálogo de produtos - Front UI/UX
...
3. Como o cliente quer manter a sua identidade corporativa no sistema, usar como referência gráfica o arquivo Adobe XD da landing page Descontrolada®: [clique aqui para baixar](https://github.com/cblx/product-catalog-test-ui-ux/blob/main/descontrolada.xd). As fontes usadas no layout estão disponíveis no [Google Fonts](https://fonts.google.com/).
